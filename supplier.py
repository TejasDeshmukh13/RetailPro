...
class NewFrame(Frame):
	def __init__(self, master):
		...
		self.frame = Frame(width=570, height=436, bg="white")
		self.frame.place(x=220, y=130)
		...
		# Creating a frame to contain the button
		self.frame_button = Frame(self.frame, bg="white")
		self.frame_button.pack(fill="x", side="bottom")

		# Create a back button
		self.btn_back = Button(self.frame_button, text="Back", font=("goudy old style", 10), bg="blue", fg="white",
		                       command=self.dashboard)
		self.btn_back.place(x=1050, y=20, width=80, height=25)

	def dashboard(self):
		self.frame.destroy()  # Destroy the frame along with its contents
		subprocess.run(['python', 'dashboard.py'])


def create_new_frame():
	root = Tk()
	supplier_obj = supplierClass(root)
...
def main():
	root = Tk()
	supplier_obj = supplierClass(root)
	create_new_frame(root)  # Create an instance of supplierClass
	root.mainloop()
...
class supplierClass(Frame):
	def __init__(self, root):
		...
		btn_new = Button(root, text="new", font=("goudy old style", 15), bg="#4caf50", fg="white", cursor="hand2",
		...
		btn_check_prd_id = Button(self.root, text="Check", font=("goudy old style", 12), bg="#4caf50", fg="white",
		                          cursor="hand2", command=self.check_prod_id)
		btn_check_prd_id.place(x=890, y=180, width=60, height=25)

		btn_check_sup_id = Button(self.root, text="Check", font=("goudy old style", 12), bg="#4caf50", fg="white",
		                          cursor="hand2", command=self.check_sup_id)
