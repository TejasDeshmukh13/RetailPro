...
class expentory:
    def __init__(self,root):
       ...
       btn_Inventoryr=Button(LeftMenu,text="Inventory",image=self.icon_side,compound=LEFT,padx=3,anchor="w",font=("times new roman",20,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
